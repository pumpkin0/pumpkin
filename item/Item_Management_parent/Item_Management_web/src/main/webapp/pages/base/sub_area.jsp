	...
	<body class="easyui-layout" style="visibility:hidden;">
		...
		<div class="easyui-window" title="分区添加修改" id="addWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
			...
			<div style="overflow:auto;padding:5px;" border="false">
				<form id="subareaForm" method="post" action="${pageContext.request.contextPath}/subarea_save.action">
					<table class="table-edit" width="80%" align="center">
						...
						<tr>
							<td>选择区域</td>
							<td>
								<input class="easyui-combobox" id = "areaId" name="area.id" 
									 data-options="valueField:'id',textField:'name',editable:true" />
								
								<!--这儿设计的不好，在必须手动点击一次下拉框，才能拉出内容  -->	 
								<script type="text/javascript">
									var inputContent;
									var run = true;
									$('#areaId').combobox({    
									    ...
									    onShowPanel:function(newValue, oldValue){
											inputContent=$('#areaId').combo('getValues');
											if(inputContent != ""){
												$('#areaId').combobox('reload','${pageContext.request.contextPath}/area_findByInputContent.action?inputContent='+inputContent);  
											}
										}
