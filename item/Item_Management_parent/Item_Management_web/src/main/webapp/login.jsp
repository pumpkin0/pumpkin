				...
				<div class="col-md-4 col-md-offset-7 logincontent">
					...
					<form class="form-horizontal" id="loginform" name="loginform" method="post" action="userAction_login.action">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<img id="loginform:vCode" name= "checkCode" src="validatecode.jsp"  onclick="javascript:document.getElementById('loginform:vCode'). src='validatecode.jsp?'+Math.random();" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="col-md-offset-3 col-md-8">
							<a href="javascript:;" id="loginformSubmitButton" name="loginform:j_id19"
