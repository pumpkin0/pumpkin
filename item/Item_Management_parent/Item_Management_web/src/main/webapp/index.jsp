...
<html>
		...
		<script type="text/javascript">
			$(function() {
				...
				*/
				...
				// 基本功能菜单加载
				$.post("${pageContext.request.contextPath}/menuAction_showMenu.action",function(data){
	...
	<body class="easyui-layout">
		<div data-options="region:'north',border:false" style="height:70px;padding:10px;">
			...
			<div id="sessionInfoDiv" style="position: absolute;right: 50px;top:10px;">
				<!-- [<strong>超级管理员</strong>]，欢迎你！您使用[<strong>192.168.1.100</strong>]IP登录！ -->
				<a href="./login.jsp" id="loginButton">登录 </a>
				<script type="text/javascript">
					$.ajax({ 
						url: "userAction_loginState.action", 
						success: function(data){
							if(data.flag == true){
								$('#sessionInfoDiv').val("[<strong>超级管理员</strong>]，欢迎你！您使用[<strong>192.168.1.100</strong>]IP登录！")
							}
						},
						dataType:"json"
					});
